...
nobody in the loop. This wave inverts it.
...
- **The escalation ladder is recorded, never automated.** Tool email → her personal email → cc the
  ...
  not to climb it.
- **A per-event switch** for anyone who genuinely wants the old behaviour. Existing events keep
  sending exactly as they do now until someone chooses otherwise.
